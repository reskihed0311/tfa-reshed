...
SWEP.PrintName				= "RM-277"		-- Weapon name (Shown on HUD)
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_reshed_rm277.mdl" --Viewmodel path
...
SWEP.IronSightsPos = Vector(-4.401, -10.806, 0.72)
SWEP.IronSightsAng = Vector(0, 0, 0)



SWEP.IronSightsPos_RDS = Vector(-4.401, -10.806, 0.40)
SWEP.IronSightsAng_RDS = Vector(0, 0, 0)

SWEP.IronSightsPos_2XRDS = Vector(-4.401, -11.806, 0.40)
SWEP.IronSightsAng_2XRDS = Vector(0, 0, 0)

SWEP.IronSightsPos_EOTech = Vector(-4.401, -10.806, 0.40)
SWEP.IronSightsAng_EOTech = Vector(0, 0, 0)

SWEP.IronSightsPos_Kobra = Vector(-4.401, -10.806, 0.65)
SWEP.IronSightsAng_Kobra = Vector(0, 0, 0)

SWEP.IronSightsPos_C79 = Vector(-4.401, -10.806, -0.21)
...
SWEP.EventTable = {
[ACT_VM_RELOAD] = {
{ ["time"] = 0, ["type"] = "sound", ["value"] = Sound("tfaweapons/rm277/raise.wav") },
{ ["time"] = 0.5, ["type"] = "sound", ["value"] = Sound("tfaweapons/rm277/magout.wav") },
{ ["time"] = 1.15, ["type"] = "sound", ["value"] = Sound("tfaweapons/rm277/maghit.wav") },
{ ["time"] = 1.30, ["type"] = "sound", ["value"] = Sound("tfaweapons/rm277/magin.wav") },
{ ["time"] = 1.9, ["type"] = "sound", ["value"] = Sound("tfaweapons/rm277/drop.wav") },
},

[ACT_VM_RELOAD_EMPTY] = {
{ ["time"] = 0, ["type"] = "sound", ["value"] = Sound("tfaweapons/rm277/raise.wav") },
{ ["time"] = 0.2, ["type"] = "sound", ["value"] = Sound("tfaweapons/rm277/magout_empty.wav") },
{ ["time"] = 2, ["type"] = "sound", ["value"] = Sound("tfaweapons/rm277/maghit.wav") },
{ ["time"] = 2.2, ["type"] = "sound", ["value"] = Sound("tfaweapons/rm277/magin.wav") },
{ ["time"] = 2.88, ["type"] = "sound", ["value"] = Sound("tfaweapons/rm277/boltforward.wav") },
{ ["time"] = 3.3, ["type"] = "sound", ["value"] = Sound("tfaweapons/rm277/drop.wav") },
}}
...
SWEP.VFGGripBoneMods = {
	["ValveBiped.Bip01_L_Finger41"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, -14.065, 0) },
	["ValveBiped.Bip01_L_Finger1"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-10.735, -76.189, -12.362) },
	["ValveBiped.Bip01_L_Clavicle"] = { scale = Vector(1, 1, 1), pos = Vector(-1.121, 0.592, -1.667), angle = Angle(0, 0, 0) },
	["ValveBiped.Bip01_L_Finger4"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-12.19, 32.493, 0) },
	["ValveBiped.Bip01_L_Finger01"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, 7.927, 0) },
	["ValveBiped.Bip01_L_Finger42"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, -14.806, 0) },
	["ValveBiped.Bip01_L_Finger2"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, -43.213, 0) },
	["ValveBiped.Bip01_L_Finger3"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, -12.158, 0) },
	["ValveBiped.Bip01_L_Finger02"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(14.932, 88.305, -2.004) },
	["ValveBiped.Bip01_L_Hand"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-42.362, 24.709, 61.944) }
...
SWEP.VFGGripBadActivities = {
	[ACT_VM_RELOAD_EMPTY] = {0.1, 0.6}, -- start, end (0 to 1)
	[ACT_VM_RELOAD] = {0.01, 0.85}, -- start, end (0 to 1)
}
...
SWEP.VElements = {
	["sights_folded"] = { type = "Model", model = "models/weapons/tfa_reshed_rm277_sights.mdl", bone = "weapon", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = true, bonemerge = true },
	...
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_suppressor_sec.mdl", bone = "muzzle", rel = "", pos = Vector(0, -0.05, -3), angle = Angle(90, 0, 0), size = Vector(0.9, 0.9, 0.9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} , bonemerge = false, active = false },
    ...
    ["vfg"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_foregrip_sec.mdl", bone = "weapon", rel = "",  pos = Vector(0, 3.424, 6.543), angle = Angle(90, 0, -90), size = Vector(0.4, 0.4, 0.4), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false }
