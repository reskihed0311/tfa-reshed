...
SWEP.PrintName				= "AK-12 (Prototype)"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfaweapons/ak12/fire1.wav") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("tfaweapons/ak12/fire_sup1.wav") -- This is the sound of the weapon, when silenced.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_reshed_ak12.mdl" --Viewmodel path
...
SWEP.IronSightsPos = Vector(-3.441, -7.711, 1.279)
...
SWEP.EventTable = {
[ACT_VM_RELOAD] = {
	{ ["time"] = 0.05, ["type"] = "sound", ["value"] = Sound("tfaweapons/ak12/maggrab.wav") },
	{ ["time"] = 0.20, ["type"] = "sound", ["value"] = Sound("tfaweapons/ak12/magout.wav") },
	{ ["time"] = 1.32, ["type"] = "sound", ["value"] = Sound("tfaweapons/ak12/magin.wav") },
},

[ACT_VM_RELOAD_EMPTY] = {
{ ["time"] = 0.70, ["type"] = "sound", ["value"] = Sound("tfaweapons/ak12/magout_fast.wav") },
{ ["time"] = 1.3, ["type"] = "sound", ["value"] = Sound("tfaweapons/ak12/magin.wav") },
{ ["time"] = 1.93, ["type"] = "sound", ["value"] = Sound("tfaweapons/ak12/bolt_back.wav") },
{ ["time"] = 2.2, ["type"] = "sound", ["value"] = Sound("tfaweapons/ak12/bolt_forward.wav") },
}}
