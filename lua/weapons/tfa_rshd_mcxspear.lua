...
SWEP.PrintName				= "SIG MCX SPEAR"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfaweapons/spear/fire_fp.wav") -- This is the sound of the weapon, when you shoot.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_reshed_mcxspear.mdl" --Viewmodel path
...
SWEP.IronSightsPos = Vector(-4.72, -7.34, 0.639)
SWEP.IronSightsAng = Vector(0, 0, 0)



SWEP.IronSightsPos_RDS = Vector(-4.72, -7.34, 0.25)
SWEP.IronSightsAng_RDS = Vector(0, 0, 0)

SWEP.IronSightsPos_2XRDS = Vector(-4.72, -10.34, 0.25)
SWEP.IronSightsAng_2XRDS = Vector(0, 0, 0)

SWEP.IronSightsPos_EOTech = Vector(-4.72, -7.34, 0.3)
SWEP.IronSightsAng_EOTech = Vector(0, 0, 0)

SWEP.IronSightsPos_Kobra = Vector(-4.72, -7.34, 0.35)
SWEP.IronSightsAng_Kobra = Vector(0, 0, 0)

SWEP.IronSightsPos_C79 = Vector(-4.72, -7.34, -0.30)
...
SWEP.EventTable = {
[ACT_VM_RELOAD] = {
{ ["time"] = 0, ["type"] = "sound", ["value"] = Sound("tfaweapons/spear/move1.wav") },
{ ["time"] = 0.45, ["type"] = "sound", ["value"] = Sound("tfaweapons/spear/magout_tac.wav") },
{ ["time"] = 1.25, ["type"] = "sound", ["value"] = Sound("tfaweapons/spear/maghit_tac.wav") },
{ ["time"] = 1.40, ["type"] = "sound", ["value"] = Sound("tfaweapons/spear/magin_tac.wav") },
{ ["time"] = 1.9, ["type"] = "sound", ["value"] = Sound("tfaweapons/spear/move1.wav") },
},

[ACT_VM_RELOAD_EMPTY] = {
{ ["time"] = 0, ["type"] = "sound", ["value"] = Sound("tfaweapons/spear/move1.wav") },
{ ["time"] = 0.1, ["type"] = "sound", ["value"] = Sound("tfaweapons/spear/magout_empty.wav") },
{ ["time"] = 1.3, ["type"] = "sound", ["value"] = Sound("tfaweapons/spear/maghit.wav") },
{ ["time"] = 1.5, ["type"] = "sound", ["value"] = Sound("tfaweapons/spear/magin.wav") },
{ ["time"] = 1.82, ["type"] = "sound", ["value"] = Sound("tfaweapons/spear/magslap.wav") },
{ ["time"] = 2.15, ["type"] = "sound", ["value"] = Sound("tfaweapons/spear/handle.wav") },
{ ["time"] = 2.25, ["type"] = "sound", ["value"] = Sound("tfaweapons/spear/pullback.wav") },
{ ["time"] = 2.54, ["type"] = "sound", ["value"] = Sound("tfaweapons/spear/pullfwd.wav") },
}}
...
SWEP.VFGGripBoneMods = {
	["ValveBiped.Bip01_L_Finger1"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(6.501, -59.817, 0) },
	["ValveBiped.Bip01_L_Finger02"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(72.994, 42.458, -5.823) },
	["ValveBiped.Bip01_L_Finger4"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(29.816, 0, 0) },
	["ValveBiped.Bip01_L_Finger01"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, 18.184, 0) },
	["ValveBiped.Bip01_L_Finger0"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(3.18, 21.672, 0) },
	["ValveBiped.Bip01_L_Finger2"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(22.763, -52.939, 0) },
	["ValveBiped.Bip01_L_Finger3"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(24.768, -23.838, 0) },
	["ValveBiped.Bip01_L_Clavicle"] = { scale = Vector(1, 1, 1), pos = Vector(-2.452, 2.68, -0.7), angle = Angle(0, 0, 0) },
	["ValveBiped.Bip01_L_Hand"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-33.946, -16.789, 63.164) }
...
SWEP.VElements = {
	["sights_folded"] = { type = "Model", model = "models/weapons/tfa_reshed_mcxspear_sights.mdl", bone = "weapon", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = true, bonemerge = true },
	["sight_kobra"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_kobra.mdl", bone = "weapon", rel = "", pos = Vector(-0.11, 0, 0), angle = Angle(90, -90, 0), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
	["sight_kobra_lens"] = (TFA.INS2 and TFA.INS2.GetHoloSightReticle) and TFA.INS2.GetHoloSightReticle("sight_kobra") or nil,
	["sight_eotech"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_eotech.mdl",  bone = "weapon", rel = "", pos = Vector(-0.11, 0, 0), angle = Angle(90, -90, 0), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
	["sight_eotech_lens"] = (TFA.INS2 and TFA.INS2.GetHoloSightReticle) and TFA.INS2.GetHoloSightReticle("sight_eotech") or nil,
	["sight_rds"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_aimpoint.mdl", bone = "weapon", rel = "", pos = Vector(-0.11, 0, 0), angle = Angle(90, -90, 0), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
	["sight_rds_lens"] = (TFA.INS2 and TFA.INS2.GetHoloSightReticle) and TFA.INS2.GetHoloSightReticle("sight_rds") or nil,
	["scope_2xrds"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_aimp2x.mdl", bone = "weapon", rel = "", pos = Vector(-0.11, 0, 0), angle = Angle(90, -90, 0), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
	...
	["scope_c79"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_elcan.mdl", bone = "weapon", rel = "", pos = Vector(-0.11, 0, 0), angle = Angle(90, -90, 0), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
	...
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_suppressor_sec.mdl", bone = "muzzle", rel = "", pos = Vector(0, -0.05, 0), angle = Angle(90, 0, 0), size = Vector(0.9, 0.9, 0.9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} , bonemerge = false, active = false },
    ...
    ["vfg"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_foregrip_sec.mdl", bone = "weapon", rel = "",  pos = Vector(0, 2.789, 8.496), angle = Angle(90, 0, -90), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false }
