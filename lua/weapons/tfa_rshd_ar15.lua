...
SWEP.SubCategory                = "Assault Rifles" -- Spawnmenu subcategory.
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("tfaweapons/ar15/fire.wav") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("tfaweapons/ar15/fire_sil.wav") -- This is the sound of the weapon, when silenced.
...
SWEP.Primary.ClipSize_ExtRifle = 60 -- This is the size of a clip
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_reshed_ar15.mdl" --Viewmodel path
...
SWEP.IronSightsPos = Vector(-5.19, -4, 0.85)
SWEP.IronSightsAng = Vector(0, 0, 0)



SWEP.IronSightsPos_RDS = Vector(-5.19, -4, 0.6)
SWEP.IronSightsAng_RDS = Vector(0, 0, 0)

SWEP.IronSightsPos_2XRDS = Vector(-5.19, -8, 0.65)
SWEP.IronSightsAng_2XRDS = Vector(0, 0, 0)

SWEP.IronSightsPos_EOTech = Vector(-5.19, -4, 0.85)
SWEP.IronSightsAng_EOTech = Vector(0, 0, 0)

SWEP.IronSightsPos_Kobra = Vector(-5.19, -4, 0.85)
SWEP.IronSightsAng_Kobra = Vector(0, 0, 0)

SWEP.IronSightsPos_C79 = Vector(-5.19, -8, 0.1)
...
SWEP.EventTable = {
[ACT_VM_RELOAD] = {
{ ["time"] = 0, ["type"] = "sound", ["value"] = Sound("tfaweapons/ar15/raise.wav") },
{ ["time"] = 0.34, ["type"] = "sound", ["value"] = Sound("tfaweapons/ar15/magout.wav") },
{ ["time"] = 0.80, ["type"] = "sound", ["value"] = Sound("tfaweapons/ar15/maghit_fast.wav") },
{ ["time"] = 0.95, ["type"] = "sound", ["value"] = Sound("tfaweapons/ar15/magin.wav") },
{ ["time"] = 1.5, ["type"] = "sound", ["value"] = Sound("tfaweapons/ar15/drop.wav") },
},

[ACT_VM_RELOAD_EMPTY] = {
{ ["time"] = 0, ["type"] = "sound", ["value"] = Sound("tfaweapons/ar15/raise.wav") },
{ ["time"] = 0.20, ["type"] = "sound", ["value"] = Sound("tfaweapons/ar15/magout_fast.wav") },
{ ["time"] = 1.6, ["type"] = "sound", ["value"] = Sound("tfaweapons/ar15/maghit_fast.wav") },
{ ["time"] = 1.8, ["type"] = "sound", ["value"] = Sound("tfaweapons/ar15/magin_fast.wav") },
{ ["time"] = 2.1, ["type"] = "sound", ["value"] = Sound("tfaweapons/ar15/bolt.wav") },
{ ["time"] = 2.5, ["type"] = "sound", ["value"] = Sound("tfaweapons/ar15/drop.wav") },
}}
...
SWEP.VFGGripBoneMods = {
	["ValveBiped.Bip01_L_Finger41"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, -36.382, 0) },
	["ValveBiped.Bip01_L_Finger1"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-9.612, -44.107, 0) },
	["ValveBiped.Bip01_L_Finger11"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-18.845, -17.514, 0) },
	["ValveBiped.Bip01_L_Clavicle"] = { scale = Vector(1, 1, 1), pos = Vector(-2.402, -0.165, -1.183), angle = Angle(0, 0, 0) },
	["ValveBiped.Bip01_L_Finger4"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(6.431, 24.045, 38.868) },
	["ValveBiped.Bip01_L_Finger0"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(21.104, 10.152, 0) },
	["ValveBiped.Bip01_L_Finger2"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(6.304, -46.159, 5.093) },
	["ValveBiped.Bip01_L_Finger3"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(16.506, -17.039, 0) },
	["ValveBiped.Bip01_L_Finger01"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-6.196, 55.455, 59.066) },
	["ValveBiped.Bip01_L_Hand"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-28.039, 1.621, 32.251) }
}

SWEP.VFGGripBadActivities = {
	[ACT_VM_RELOAD_EMPTY] = {0.1, 0.9}, -- start, end (0 to 1)
	[ACT_VM_RELOAD] = {0.05, 0.8}, -- start, end (0 to 1)
}
...
SWEP.VElements = {
	["sights_folded"] = { type = "Model", model = "models/weapons/tfa_reshed_ar15_carryhandle.mdl", bone = "weapon", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = true, bonemerge = true },
	...
	["m16stock"] = { type = "Model", model = "models/weapons/tfa_reshed_ar15_m16stock.mdl", bone = "Weapon", rel = "", pos = Vector(0, -0.9, 0.3), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false},
	...
	["vfg"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_foregrip_sec1.mdl", bone = "weapon", rel = "", pos = Vector(0, 2.378, 8.711), angle = Angle(90, 0, -90), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, active = false, bodygroup = {} }
...
SWEP.Attachments = {
	...
	[3] = { offset = { 0, 0 }, atts = { "ar15_si_folded", "ins2_si_kobra", "ins2_si_eotech", "ins2_si_rds", "ins2_si_2xrds", "ins2_si_c79" }, order = 2 },
