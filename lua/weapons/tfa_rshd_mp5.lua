...
SWEP.ViewModel = "models/weapons/tfa_reshed_mp5.mdl" --Viewmodel path
...
SWEP.IronSightsPos = Vector( -4.008, -9.749, 0.939 )
SWEP.IronSightsAng = Vector( 0.419, 0, 0 )
SWEP.IronSightsPos_Kobra = Vector(-4.008, -9.749, -0.15 )
SWEP.IronSightsAng_Kobra = Vector( 0, 0, 0 )
SWEP.IronSightsPos_EOTech = Vector( -4.008, -9.749, -0.35 )
SWEP.IronSightsAng_EOTech = Vector( 0, 0, 0 )
SWEP.IronSightsPos_RDS = Vector( -4.008, -9.749, -0.35 )
SWEP.IronSightsAng_RDS = Vector( 0, 0, 0 )
SWEP.IronSightsPos_2XRDS = Vector( -4.008, -7.749, -0.35 )
SWEP.IronSightsAng_2XRDS = Vector( 0, -0.051, 0 )
SWEP.IronSightsPos_C79 = Vector( -4.008, -7.749, -0.8 )
...
{ ["time"] = 0.3, ["type"] = "sound", ["value"] = Sound("tfaweapons/mp5/magout.wav") },
{ ["time"] = 0.8, ["type"] = "sound", ["value"] = Sound("tfaweapons/mp5/magin.wav") },
{ ["time"] = 1, ["type"] = "sound", ["value"] = Sound("tfaweapons/mp5/raise.wav") },
},
[ACT_VM_DRAW] = {
{ ["time"] = 0, ["type"] = "sound", ["value"] = Sound("tfaweapons/mp5/raise.wav") },
},
[ACT_VM_HOLSTER] = {
{ ["time"] = 0, ["type"] = "sound", ["value"] = Sound("tfaweapons/mp5/drop.wav") },
},
[ACT_VM_RELOAD_EMPTY] = {
{ ["time"] = 0, ["type"] = "sound", ["value"] = Sound("tfaweapons/mp5/raise.wav") },
{ ["time"] = 0.15, ["type"] = "sound", ["value"] = Sound("tfaweapons/mp5/boltback4.wav") },
{ ["time"] = 0.7, ["type"] = "sound", ["value"] = Sound("tfaweapons/mp5/magout_empty.wav")},
{ ["time"] = 1.89, ["type"] = "sound", ["value"] = Sound("tfaweapons/mp5/magin.wav") },
{ ["time"] = 2.45, ["type"] = "sound", ["value"] = Sound("tfaweapons/mp5/boltrel2.wav") },
}
}
...
SWEP.Attachments = {
    ...
    [3] = {
        offset = { 0, 0 },
        atts = { "ins2_si_kobra", "ins2_si_eotech", "ins2_si_rds", "ins2_si_2xrds", "ins2_si_c79" },
        order = 1
    },
}
...
SWEP.VFGGripBoneMods = {
	["ValveBiped.Bip01_L_Finger1"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-10.018, -57.119, 0) },
	["ValveBiped.Bip01_L_Finger02"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, 64.397, 0) },
	["ValveBiped.Bip01_L_Finger4"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(17.341, 9.921, 0) },
	["ValveBiped.Bip01_L_Hand"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-40.362, 11.246, 37.733) },
	["ValveBiped.Bip01_L_Finger2"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(7.828, -50.209, 0) },
	["ValveBiped.Bip01_L_Finger01"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(13.088, 45.659, -21.526) },
	["ValveBiped.Bip01_L_Finger3"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(18.952, -7.33, 0) },
	["ValveBiped.Bip01_L_Clavicle"] = { scale = Vector(1, 1, 1), pos = Vector(-2.241, 0.389, -0.871), angle = Angle(0, 0, 0) },
	["ValveBiped.Bip01_L_Finger0"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(17.673, 0, 0) }
