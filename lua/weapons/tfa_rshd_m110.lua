...
SWEP.DrawCrosshairIS = false --Draw the crosshair in s?
SWEP.PrintName = "M110" -- Weapon name (Shown on HUD)
SWEP.SubCategory                = "DMRs" -- Spawnmenu subcategory.
SWEP.Type = "DMR"
...
--[[WEAPON HANDLING]]
--
SWEP.Primary.Sound = "tfaweapons/m110/fire_fp.wav" -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound      = "tfaweapons/m110/fire_sil.wav" -- This is the sound of the weapon, when silenced.
...
SWEP.ViewModel = "models/weapons/tfa_reshed_m110.mdl" --Viewmodel path
...
SWEP.IronSightsPos = Vector( -3.6, -5.891, 0.159 )
SWEP.IronSightsAng = Vector( 0, 0, 0 )
SWEP.IronSightsPos_Kobra = Vector(-3.6, -5.891, 0.159 )
SWEP.IronSightsAng_Kobra = Vector( 0, 0, 0 )
SWEP.IronSightsPos_EOTech = Vector( -3.6, -5.891, 0.159 )
SWEP.IronSightsAng_EOTech = Vector( 0, 0, 0 )
SWEP.IronSightsPos_RDS = Vector( -3.6, -5.891, 0.159 )
SWEP.IronSightsAng_RDS = Vector( 0, 0, 0 )
SWEP.IronSightsPos_2XRDS = Vector( -3.6, -5.891, 0.159 )
SWEP.IronSightsAng_2XRDS = Vector( 0, 0, 0 )
SWEP.IronSightsPos_C79 = Vector(-3.6, -5.891, 0.159 )
SWEP.IronSightsAng_C79 = Vector( 0, 0, 0 )
SWEP.IronSightsPos_PO4X = Vector( -3.6, -5.891, 0.159 )
...
SWEP.EventTable = {
[ACT_VM_RELOAD] = {
{ ["time"] = 0, ["type"] = "sound", ["value"] = Sound("tfaweapons/m110/raise.wav") },
{ ["time"] = 0.35, ["type"] = "sound", ["value"] = Sound("tfaweapons/m110/magout.wav") },
{ ["time"] = 0.83, ["type"] = "sound", ["value"] = Sound("tfaweapons/m110/maghit.wav") },
{ ["time"] = 1, ["type"] = "sound", ["value"] = Sound("tfaweapons/m110/magin.wav") },
},
[ACT_VM_DRAW] = {
{ ["time"] = 0, ["type"] = "sound", ["value"] = Sound("tfaweapons/m110/raise.wav") },
},
...
[ACT_VM_HOLSTER] = {
{ ["time"] = 0, ["type"] = "sound", ["value"] = Sound("tfaweapons/m110/drop.wav") },
},
...
[ACT_VM_RELOAD_EMPTY] = {
{ ["time"] = 0, ["type"] = "sound", ["value"] = Sound("tfaweapons/m110/raise.wav") },
{ ["time"] = 0.27, ["type"] = "sound", ["value"] = Sound("tfaweapons/m110/magout_fast.wav") },
{ ["time"] = 1.3, ["type"] = "sound", ["value"] = Sound("tfaweapons/m110/maghit.wav") },
{ ["time"] = 1.45, ["type"] = "sound", ["value"] = Sound("tfaweapons/m110/magin.wav") },
{ ["time"] = 1.85, ["type"] = "sound", ["value"] = Sound("tfaweapons/m110/boltcatch.wav") },
}
}
...
SWEP.VElements = {
    ["sights_folded"] = { type = "Model", model = "models/weapons/tfa_reshed_m110_sights.mdl", bone = "weapon", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = true, bonemerge = true },
    ["sight_kobra"] = {
        type = "Model",
...
SWEP.VFGGripBoneMods = {
	["ValveBiped.Bip01_L_Finger41"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, -8.601, 0) },
	["ValveBiped.Bip01_L_Finger1"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-16.077, -33.127, 9.51) },
	["ValveBiped.Bip01_L_Finger21"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, -15.53, 0) },
	["ValveBiped.Bip01_L_Finger11"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, -17.015, 0) },
	["ValveBiped.Bip01_L_Finger02"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(14.769, 13.086, -28.889) },
	["ValveBiped.Bip01_L_Finger2"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(2.443, -16.292, 0) },
	["ValveBiped.Bip01_L_Finger4"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, 41.05, 5.118) },
	["ValveBiped.Bip01_L_UpperArm"] = { scale = Vector(1, 1, 1), pos = Vector(-0.424, -3.595, -1.201), angle = Angle(0, 0, 0) },
	["ValveBiped.Bip01_L_Hand"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-36.675, 7.83, 41.303) },
	["ValveBiped.Bip01_L_Finger42"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, -33.55, 0) },
	["ValveBiped.Bip01_L_Finger01"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, 0, -11.013) },
	["ValveBiped.Bip01_L_Finger12"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, -43.077, 0) },
	["ValveBiped.Bip01_L_Finger0"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(1.766, 1.396, -0.844) }
}
