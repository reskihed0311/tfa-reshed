...
SWEP.IronSightsPos_Kobra = Vector(-3.6, -5.891, 0.5 )
SWEP.IronSightsAng_Kobra = Vector( 0, 0, 0 )
SWEP.IronSightsPos_EOTech = Vector( -3.6, -5.891, 0.39 )
SWEP.IronSightsAng_EOTech = Vector( 0, 0, 0 )
SWEP.IronSightsPos_RDS = Vector( -3.6, -5.891, 0.30 )
SWEP.IronSightsAng_RDS = Vector( 0, 0, 0 )
SWEP.IronSightsPos_2XRDS = Vector( -3.6, -8.891, 0.30 )
SWEP.IronSightsAng_2XRDS = Vector( 0, 0, 0 )
SWEP.IronSightsPos_C79 = Vector(-3.6, -5.891, -0.18 )
SWEP.IronSightsAng_C79 = Vector( 0, 0, 0 )
SWEP.IronSightsPos_PO4X = Vector( -3.55, -6.891, 0.42 )
