...
--[[WEAPON HANDLING]]
--
SWEP.Primary.Sound = "tfaweapons/vss/fire_fp.wav" -- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel = "models/weapons/tfa_reshed_vss.mdl" --Viewmodel path
...
SWEP.IronSightsPos = Vector( -3.36, -5.603, 1.12 )
SWEP.IronSightsAng = Vector( 0.419, 0, 0 )
SWEP.IronSightsPos_Kobra = Vector( -3.441, -6.052, -0.7 )
SWEP.IronSightsAng_Kobra = Vector( 0, 0, 0 )
SWEP.IronSightsPos_EOTech = Vector( -3.441, -6.052, -0.8 )
SWEP.IronSightsAng_EOTech = Vector( 0, 0, 0 )
SWEP.IronSightsPos_RDS = Vector( -3.441, -6.052, -1 )
SWEP.IronSightsAng_RDS = Vector( 0, 0, 0 )
SWEP.IronSightsPos_2XRDS = Vector( -3.441, -6.052, -1 )
SWEP.IronSightsAng_2XRDS = Vector( 0, -0.051, 0 )
SWEP.IronSightsPos_C79 = Vector( -3.441, -4.052, -1.5 )
SWEP.IronSightsAng_C79 = Vector( 0, 0, 0 )
SWEP.IronSightsPos_PO4X = Vector( -3.38, -4.052, -0.9 )
...
SWEP.EventTable = {
[ACT_VM_RELOAD] = {
{ ["time"] = 0, ["type"] = "sound", ["value"] = Sound("tfaweapons/vss/raise.wav") },
{ ["time"] = 0.5, ["type"] = "sound", ["value"] = Sound("tfaweapons/vss/magout.wav") },
{ ["time"] = 0.8, ["type"] = "sound", ["value"] = Sound("tfaweapons/vss/drop.wav") },
{ ["time"] = 1.10, ["type"] = "sound", ["value"] = Sound("tfaweapons/vss/maghit.wav") },
{ ["time"] = 1.15, ["type"] = "sound", ["value"] = Sound("tfaweapons/vss/magin.wav") },
{ ["time"] = 1.5, ["type"] = "sound", ["value"] = Sound("tfaweapons/vss/raise.wav") },
},
[ACT_VM_DRAW] = {
{ ["time"] = 0, ["type"] = "sound", ["value"] = Sound("tfaweapons/vss/raise.wav") },
},
[ACT_VM_HOLSTER] = {
{ ["time"] = 0, ["type"] = "sound", ["value"] = Sound("tfaweapons/vss/drop.wav") },
},
[ACT_VM_RELOAD_EMPTY] = {
{ ["time"] = 0, ["type"] = "sound", ["value"] = Sound("tfaweapons/vss/raise.wav") },
{ ["time"] = 0.6, ["type"] = "sound", ["value"] = Sound("tfaweapons/vss/magout_empty.wav") },
{ ["time"] = 1.21, ["type"] = "sound", ["value"] = Sound("tfaweapons/vss/maghit.wav") },
{ ["time"] = 1.31, ["type"] = "sound", ["value"] = Sound("tfaweapons/vss/magin.wav") },
{ ["time"] = 1.70, ["type"] = "sound", ["value"] = Sound("tfaweapons/vss/boltback.wav") },
{ ["time"] = 1.85, ["type"] = "sound", ["value"] = Sound("tfaweapons/vss/boltfwd.wav") },
}
}
...
SWEP.VElements = {
    ["rail_sights"] = {
        type = "Model",
        model = "models/weapons/shared/a_modkit_ak.mdl",
        bone = "weapon",
        rel = "",
        pos = Vector( 2.20, -2, -6.8 ),
        angle = Angle( 90, 0, -90 ),
        size = Vector( 1, 1, 1 ),
